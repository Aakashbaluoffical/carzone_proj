        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.company-logo img').attr('src', 'https://cdn.rcstatic.com/images/site_graphics/newsite/mobile/logos/rc-logo-small--white.svg');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    $('.company-logo img').attr('src', 'static/pages/logos/car-logo.png');
                } else {
                    $('.company-logo img').attr('src', 'static/pages/logos/car-logo.png');
                }
            }
