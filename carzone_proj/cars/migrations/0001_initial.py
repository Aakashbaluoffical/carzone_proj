# Generated by Django 4.0.3 on 2022-03-27 14:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_type', models.CharField(max_length=256)),
                ('no_of_owners', models.CharField(max_length=256)),
                ('is_feature', models.BooleanField(max_length=256)),
                ('created_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 3, 27, 19, 57, 30, 858301))),
            ],
        ),
    ]
